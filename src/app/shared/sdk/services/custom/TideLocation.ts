...
/**
 * Api services for the `TideLocation` model.
 */
@Injectable()
export class TideLocationApi extends BaseLoopBackApi {
  ...
  /**
   * Find a related item by id for tides.
   *
   * @param {any} id TideLocation id
   *
   * @param {any} fk Foreign key for tides
   *
  ...
  /**
   * Delete a related item by id for tides.
   *
   * @param {any} id TideLocation id
   *
   * @param {any} fk Foreign key for tides
  ...
  /**
   * Update a related item by id for tides.
   *
   * @param {any} id TideLocation id
   *
   * @param {any} fk Foreign key for tides
  ...
  /**
   * Creates a new instance in tides of this model.
   *
   * @param {any} id TideLocation id
   *
   * @param {object} data Request data.
  ...
  /**
   * Deletes all tides of this model.
   *
   * @param {any} id TideLocation id
   *
   * @returns {object} An empty reference that will be
   ...
   *
   * @param {number} location_id Id of location
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
  ...
  public getForecast(location_id: any): Observable<any> {
    ...
    let _postBody: any = {};
    let _urlParams: any = {};
    if (location_id) _urlParams.location_id = location_id;
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody);
    return result;
  }
