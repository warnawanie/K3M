...
/**
 * Api services for the `CustomerSubCategory` model.
 */
@Injectable()
export class CustomerSubCategoryApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id CustomerSubCategory id
   *
  ...
  /**
   * Queries customers of CustomerSubCategory.
   *
   * @param {any} id CustomerSubCategory id
   *
   * @param {object} filter 
  ...
  /**
   * Counts customers of CustomerSubCategory.
   *
   * @param {any} id CustomerSubCategory id
   *
