...
/**
 * Api services for the `StatusReport` model.
 */
@Injectable()
export class StatusReportApi extends BaseLoopBackApi {
  ...
  /**
   * Queries reports of StatusReport.
   *
   * @param {any} id StatusReport id
   *
   * @param {object} filter 
  ...
  /**
   * Counts reports of StatusReport.
   *
   * @param {any} id StatusReport id
   *
  ...
  public countReports(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/status-report/:id/reports/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
