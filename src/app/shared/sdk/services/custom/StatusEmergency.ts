...
/**
 * Api services for the `StatusEmergency` model.
 */
@Injectable()
export class StatusEmergencyApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id StatusEmergency id
   *
  ...
  /**
   * Queries emergencies of StatusEmergency.
   *
   * @param {any} id StatusEmergency id
   *
   * @param {object} filter 
  ...
  /**
   * Counts emergencies of StatusEmergency.
   *
   * @param {any} id StatusEmergency id
   *
