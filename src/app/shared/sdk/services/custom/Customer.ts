...
export class CustomerApi extends BaseLoopBackApi {
   ...
   * @param {any} id Customer id
   *
   * @param {any} fk Foreign key for emergencies
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
   ...
   * </em>
   */
  public getSubcategory(id: any, refresh: any = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/:id/subcategory";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Queries emergencies of Customer.
   *
   * @param {any} id Customer id
   *
   * @param {object} filter 
  ...
  /**
   * Counts emergencies of Customer.
   *
   * @param {any} id Customer id
   *
   * @param {object} where Criteria to match model instances
