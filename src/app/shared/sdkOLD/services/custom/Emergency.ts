...
/**
 * Api services for the `Emergency` model.
 */
@Injectable()
export class EmergencyApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public getStatus(id: any, refresh: any = {}): Observable<any> {
